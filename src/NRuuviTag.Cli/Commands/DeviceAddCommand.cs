...
namespace NRuuviTag.Cli.Commands {
    ...
    public class DeviceAddCommandSettings : CommandSettings {
        ...
        [Description("The device ID to use when publishing samples to the MQTT broker. If not specified, the MQTT device ID will be generated by hashing the MAC address.")]

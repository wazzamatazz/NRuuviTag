...
NRuuviTag.AzureEventHubs.Agent allows NRuuviTag to publish Ruuvi sensor data to an [Azure Event Hub](https://azure.microsoft.com/en-us/services/event-hubs/).
...
Use the `AzureEventHubAgent` class to publish samples received from an `IRuuviTagListener` implementation to an Azure Event Hub:
